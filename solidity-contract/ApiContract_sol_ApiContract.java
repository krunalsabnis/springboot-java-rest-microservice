 ...
 */
public class ApiContract_sol_ApiContract extends Contract {
    ...
    protected ApiContract_sol_ApiContract(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected ApiContract_sol_ApiContract(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<ApiContract_sol_ApiContract> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, List<byte[]> apiEndPoint) {
        ...
        return deployRemoteCall(ApiContract_sol_ApiContract.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<ApiContract_sol_ApiContract> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, List<byte[]> apiEndPoint) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Bytes32>(
                        org.web3j.abi.Utils.typeMap(apiEndPoint, org.web3j.abi.datatypes.generated.Bytes32.class))));
        return deployRemoteCall(ApiContract_sol_ApiContract.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static ApiContract_sol_ApiContract load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ApiContract_sol_ApiContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static ApiContract_sol_ApiContract load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ApiContract_sol_ApiContract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
}
